...
export function HolderDashboard() {
  ...
  return (
    <section className="relative z-0 overflow-hidden rounded-3xl border border-purple-500/50 bg-gradient-to-br from-black via-purple-950/40 to-black p-6 shadow-[0_0_45px_#8247E533]">
      <div className="mb-6">
