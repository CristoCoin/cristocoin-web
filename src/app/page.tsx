...
<section className="relative px-6 pt-10 pb-8 md:min-h-[58vh] md:px-16 md:pt-16 md:pb-10">
...
<div className="mt-5 mb-5 grid gap-3 text-sm md:grid-cols-3">
  ...
  <div className="rounded-xl border border-purple-500/25 bg-black/35 p-4">
    ...
    <div className="mt-6 max-w-3xl rounded-2xl border border-[#D4AF37]/30 bg-[#D4AF37]/10 px-4 py-3 text-xs leading-relaxed text-zinc-300">
